...
public class Billing_1m extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        tv_pricePerWeek1.setText("$"+Math.round((price_TnN/4)*100.0)/100.0+"/ Week");
        tv_pricePerSub2.setText("$"+price_T+"/ Month");
        tv_pricePerWeek2.setText("$"+Math.round((price_T/4)*100.0)/100.0+"/ Week");
